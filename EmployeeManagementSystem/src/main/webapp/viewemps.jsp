        		  ...
        		  <c:forEach items="${empList}" var="employee">
        		  		<tr>
							<td>${employee.id}</td>
        		  			...
        		  			<td>
        		  				<a href = 'edit.jsp?id=${employee.id}&email=${employee.email}&name=${employee.name}&age=${employee.age}&mobile=${employee.mobile}&department=${employee.department}&address=${employee.address}'>Edit</a>
        		  			</td>
        		  			<td>
